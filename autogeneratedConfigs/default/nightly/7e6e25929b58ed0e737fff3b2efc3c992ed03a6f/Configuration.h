...
#define STRING_CONFIG_H_AUTHOR "(Dust, valerionew, Ender-3, zisismaras, oskardotglobal)" //ORIGINAL: #define STRING_CONFIG_H_AUTHOR "(Dust, valerionew, Ender-3)" // Original author or contributor.
 ...
 */
#define BAUDRATE 250000 //ORIGINAL: #define BAUDRATE 115200
