 ...
 */
  ...
  #define SOUND_MENU_ITEM //ORIGINAL:   //#define SOUND_MENU_ITEM   // Add a mute option to the LCD menu
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define PRINT_PROGRESS_SHOW_DECIMALS  // Show/report progress with decimal digits, not all UIs support this
    ...
    #define LCD_PROGRESS_BAR //ORIGINAL:     //#define LCD_PROGRESS_BAR            // Show a progress bar on HD44780 LCDs for SD printing
  ...
  #define LONG_FILENAME_HOST_SUPPORT //ORIGINAL:   //#define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  ...
  #define AUTO_REPORT_SD_STATUS //ORIGINAL:   //#define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>'
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT //ORIGINAL: #define ARC_SUPPORT                   // Requires ~3226 bytes
...
#define ADVANCED_OK //ORIGINAL: //#define ADVANCED_OK
 ...
 */
#define M114_DETAIL //ORIGINAL: //#define M114_DETAIL         // Use 'M114 D' for details to check planner calculations
#define M114_REALTIME //ORIGINAL: //#define M114_REALTIME       // Real current position based on forward kinematics
...
#define REPORT_FAN_CHANGE //ORIGINAL: //#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others)

/**
 * Auto-report temperatures with M155 S<seconds>
 */
#define AUTO_REPORT_TEMPERATURES //ORIGINAL: #define AUTO_REPORT_TEMPERATURES
 ...
 */
#define AUTO_REPORT_POSITION //ORIGINAL: //#define AUTO_REPORT_POSITION
...
#define CAPABILITIES_REPORT
  ...
  #define EXTENDED_CAPABILITIES_REPORT //ORIGINAL:   #define EXTENDED_CAPABILITIES_REPORT
 ...
 */
#define MEATPACK_ON_SERIAL_PORT_1 //ORIGINAL: //#define MEATPACK_ON_SERIAL_PORT_1
//#define MEATPACK_ON_SERIAL_PORT_2

#define GCODE_CASE_INSENSITIVE //ORIGINAL: //#define GCODE_CASE_INSENSITIVE  // Accept G-code sent to the firmware in lowercase
...
#define HOST_ACTION_COMMANDS //ORIGINAL: //#define HOST_ACTION_COMMANDS
  ...
  #define HOST_PROMPT_SUPPORT //ORIGINAL:   //#define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback
  #if ENABLED(HOST_PROMPT_SUPPORT)
    //#define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications
  #endif
  #define HOST_START_MENU_ITEM //ORIGINAL:   //#define HOST_START_MENU_ITEM          // Add a menu item that tells the host to start
